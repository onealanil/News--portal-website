...
function HeroSubs({ imgSrc, articleTitle, articleWriter, snippet, altImg }) {
  return (
    <div>
      {/* image and news */}
      <div className=" w-[100%]  md:px-4 flex justify-center">
        <div className="md:bg-gray-200 w-[100%] md:w-75% flex flex-row rounded-md md:gap-4 ">
          <div className="rounded-md relative w-[90%] md:w-[50%] overflow-hidden object-cover aspect-video">
            <img
              src={imgSrc}
              alt={altImg}
          ...
          <div className="hidden md:flex flex-1 items-center px-4">
            <div className="flex flex-col space-y-2 pr-4">
              <p className={`md:line-clamp-6  text-justify sm:text-xs md:text-sm lg:text-base`}>
